...
if (postElement.querySelector('.ai-comment-generator-btn')) {
    ...
    const actionsBar = postElement.querySelector('.feed-shared-social-action-bar, .social-details-social-activity__social-actions');
...
function scanForPosts() {
    const posts = document.querySelectorAll('div[data-urn*="urn:li:activity:"], div[data-urn*="urn:li:share:"], .profile-creator-shared-feed-update__container');
